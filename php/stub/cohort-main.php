...
foreach($cohorts as $index => $element) {
   ...
   echo "<a href=\"cohort.php?cohort=" . $element->getCohortId() . "\" class=\"col-xs-4\">" . $element->getStartDate()->format("M Y") . "</p>";
   echo "<a href=\"cohort.php?cohort=" . $element->getCohortId() . "\" class=\"col-xs-4\">" . $element->getLocation() . "</p>";
}
